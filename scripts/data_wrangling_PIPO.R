...
#this PIPO data wrangling is based of of successful PIPO wrangling
#for more in depth details of my process, start with data_wrangling_PIPO
...
#my first goal is to structurally rearrange PIPO data (Dead, PercentBrown, Porometer, Weight)
...
#right now I don't know which is better for analysis. I am proceding with NA
...
Phase1_PIPO <- merge(Phase1_PIPO_Weight_NA_pivot, 
                     Phase1_PIPO_Porometer_NA_pivot, 
                     Phase1_PIPO_PercentBrown_NA_pivot, 
                     Phase1_PIPO_Dead_NA_pivot, by=c("Species","SpeciesID","Week"))
