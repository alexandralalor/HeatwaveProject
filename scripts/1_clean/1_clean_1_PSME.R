...
Phase2_PSME_Dead <- read_csv(file = "data_raw/plant_data/Phase2_PSME_Dead.csv")
Phase2_PSME_PercentBrown <- read_csv(file = "data_raw/plant_data/Phase2_PSME_PercentBrown.csv")
Phase2_PSME_Porometer <- read_csv(file = "data_raw/plant_data/Phase2_PSME_Porometer.csv")
Phase2_PSME_Weight <- read_csv(file = "data_raw/plant_data/Phase2_PSME_Weight.csv")
...
#finally, make a CSV!
write.csv(PSME, "data_raw/plant_data_2/PSME.csv", quote = FALSE, row.names = FALSE)
